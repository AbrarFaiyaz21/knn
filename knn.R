library(ggplot2)
Mydata<-read.csv("D:/University/11th semester/data mining/mid/fake_bills.csv",header = TRUE,sep = ";")
Mydata
...
sum(diag(confusion_manhattan))/nrow(test_data)
...
sum(diag(confusion_maximum))/nrow(test_data)
